...
export const NAV: NavGroup[] = [
  {
    ...
    items: [
      ...
      { key: "onboarding-tour", label: "Onboarding Tour", icon: "Zap", href: "/repos/:repoId/onboarding" },
      { key: "project-context", label: "Project Context", icon: "FileText", href: "/project-context" },
    ],
  },
  {
    section: "SKILLS LAB",
