...
| [engineering-insights](engineering-insights/SKILL.md)       | All modules | Always-on: reads INSIGHTS.md at session start, appends non-obvious findings at session end |
